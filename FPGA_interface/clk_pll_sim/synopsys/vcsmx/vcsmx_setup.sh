...
# (C) 2001-2560 Altera Corporation. All rights reserved.
...
# ACDS 17.1 590 win32 2560.12.22.17:08:17
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clk_pll.vho"
fi
